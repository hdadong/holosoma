...
# SkillMimic BallPlay(-M) body_pos follows IsaacGym rigid-body order (53 joints),
# which inserts "Spine2" between "Spine" and "Chest".
SKILLMIMIC_DEMO_JOINTS = [
    "Pelvis",
    "L_Hip",
    "L_Knee",
    "L_Ankle",
...
DATA_FORMAT_CONSTANTS: dict[str, FormatConstants] = {
    ...
    "skillmimic": {
        # SkillMimic BallPlay data is in meters and close to ~1.94m human scale.
        "default_human_height": 1.94,
    },
    "mocap": {
...
DEMO_JOINTS_REGISTRY: dict[str, list[str]] = {
    ...
    "skillmimic": SKILLMIMIC_DEMO_JOINTS,
